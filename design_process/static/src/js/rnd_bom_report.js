odoo.define('design_process.mrp_bom_report', function (require) {
'use strict';
...
var MrpBomReportAdd = stock_report_generic.extend({
    events: {
        ...
        'click .o_mrp_bom_add': '_onClickActionAdd',
    },
    get_html: function() {
        var self = this;
        var args = [
    ...
    _onClickActionAdd: function (ev) {
        ...
        return this.do_action({
            ...
            context: {
                'default_bom_id': $(ev.currentTarget).data('bom') || false,
                'default_product_tmpl_id': $(ev.currentTarget).data('prod')
            },
            view_id: 'views_bom_request',
            target: 'new',
...
core.action_registry.add('mrp_bom_report', MrpBomReportAdd);
return MrpBomReportAdd;
