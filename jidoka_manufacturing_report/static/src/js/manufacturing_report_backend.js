odoo.define("jidoka_manufacturing_report.manufacturing_report_backend", function (require) {
    "use strict";
    ...
    core.action_registry.add("manufacturing_report_backend", report_backend);
