odoo.define("jidoka_manufacturing_report.manufacturing_rekap_order_backend", function (require) {
    "use strict";
    ...
    core.action_registry.add("manufacturing_rekap_order_backend", report_backend);
