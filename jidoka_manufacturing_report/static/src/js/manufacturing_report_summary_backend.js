odoo.define("jidoka_manufacturing_report.manufacturing_report_summary_backend", function (require) {
    "use strict";
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            "click .o_manufacturing_reports_print": "print",
            "click .o_manufacturing_reports_export": "export",
        },
    ...
    core.action_registry.add("manufacturing_report_summary_backend", report_backend);
