...
class WizardDesignDetailConfirm(models.TransientModel):
    _name = 'wizard.design.detail.confirm'
    _description = 'Wizard Design Detail Confirm'
    
    crm_id = fields.Many2one('crm.lead', string='CRM')
    detail_line_ids = fields.One2many('wizard.design.detail.confirm.line', 'wizard_design_detail_id', string='Detail Line')
    ...
    def action_confirm(self):
        # t_design_crm = len(self.crm_id.design_detail_ids.search([('crm_id','=',self.crm_id.id),('state','=','in_review')]))
...
class WizardDesignDetailConfirmLine(models.TransientModel):
    _name = 'wizard.design.detail.confirm.line'
    _description = 'Wizard Design Detail Confirm Line'

    wizard_design_detail_id = fields.Many2one('wizard.design.detail.confirm', string='Wizard Design Detail')
